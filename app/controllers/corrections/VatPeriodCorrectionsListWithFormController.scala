        ...
        result.fold(
          ...
          _ =>
            findCorrectionsWithCountriesInAnswersWhereNoSubmissionMade(vatPeriodCorrectionsService) {
              ...
              Ok(view(form, waypoints, period, completedCorrectionPeriodsModel, correctionPeriodsWithNoVatCorrection, isIntermediary = request.isIntermediary, companyName = request.registrationWrapper.getCompanyName()))
            } orWhenEmpty {
      ...
      findCorrectionsWithCountriesInAnswersWhereNoSubmissionMade(vatPeriodCorrectionsService) {
        findPeriodOfCountryCorrectionsWithNoVatCorrectionInAnswersAndShowCountriesPage(
          ...
          form.bindFromRequest().fold(
            formWithErrors => {
              BadRequest(view(formWithErrors, waypoints, period, completedCorrectionPeriodsModel, correctionPeriodsWithNoVatCorrection, isIntermediary = request.isIntermediary, companyName = request.registrationWrapper.getCompanyName()))
            },
            value => {
