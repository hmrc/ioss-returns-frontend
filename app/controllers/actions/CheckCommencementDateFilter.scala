...
class CheckCommencementDateFilterImpl()(implicit val executionContext: ExecutionContext)
...
class CheckCommencementDateFilter @Inject()()(implicit ec: ExecutionContext) {

  def apply(): CheckCommencementDateFilterImpl =
    new CheckCommencementDateFilterImpl()
}