...
object EtmpVatReturnCorrectionsData extends SpecBase {
  ...
  val etmpVatReturnCorrectionSingleCountryScenario: EtmpVatReturn = EtmpVatReturn(
    ...
    correctionPreviousVATReturn = Seq(
      EtmpVatReturnCorrection(
        periodKey = "23AH",
        periodFrom = LocalDate.of(2023, 8, 1).format(etmpDateFormatter),
        periodTo = LocalDate.of(2023, 8, 31).format(etmpDateFormatter),
        msOfConsumption = "DE",
      ...
      EtmpVatReturnCorrection(
        periodKey = "23AI",
        periodFrom = LocalDate.of(2023, 9, 1).format(etmpDateFormatter),
        periodTo = LocalDate.of(2023, 9, 30).format(etmpDateFormatter),
        msOfConsumption = "DE",
        totalVATAmountCorrectionGBP = BigDecimal(-1000),
        totalVATAmountCorrectionEUR = BigDecimal(-1100.41)
      ),
      EtmpVatReturnCorrection(
        periodKey = "23AJ",
        periodFrom = LocalDate.of(2023, 10, 1).format(etmpDateFormatter),
        periodTo = LocalDate.of(2023, 10, 31).format(etmpDateFormatter),
        msOfConsumption = "DE",
        totalVATAmountCorrectionGBP = BigDecimal(-1000),
        totalVATAmountCorrectionEUR = BigDecimal(-1100.41)
      ),
  ...
  val etmpVatReturnCorrectionMultipleCountryMixPosAndNegCorrectionsScenario: EtmpVatReturn = EtmpVatReturn(
    ...
    correctionPreviousVATReturn = Seq(
      ...
      EtmpVatReturnCorrection(
        periodKey = "23AK",
        periodFrom = LocalDate.of(2023, 11, 1).format(etmpDateFormatter),
        periodTo = LocalDate.of(2023, 11, 30).format(etmpDateFormatter),
        msOfConsumption = "HR",
        totalVATAmountCorrectionGBP = BigDecimal(250),
        totalVATAmountCorrectionEUR = BigDecimal(275.10)
      ),
