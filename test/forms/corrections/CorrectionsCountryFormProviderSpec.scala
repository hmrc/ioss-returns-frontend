...
class CorrectionsCountryFormProviderSpec extends StringFieldBehaviours {
  ...
  "CorrectionCountryFormProvider" - {

    val form = new CorrectionCountryFormProvider()(index, emptyExistingAnswers)
