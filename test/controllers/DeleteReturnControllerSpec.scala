  ...
  "DeleteReturn Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        contentAsString(result) `mustBe` view(form, period)(request, messages(application)).toString
      }
    }
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      running(application) {
        ...
        contentAsString(result) `mustBe` view(boundForm, period)(request, messages(application)).toString
      }
    }
