  ...
  "DeleteVatRateSalesForCountry Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustBe view(form, waypoints, period, index, index, vatRate, country, isIntermediary = false)(request, messages(application)).toString
      }
    }
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustBe view(boundForm, waypoints, period, index, index, vatRate, country, isIntermediary = false)(request, messages(application)).toString
      }
    }
