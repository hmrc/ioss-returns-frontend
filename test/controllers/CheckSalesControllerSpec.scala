  ...
  "CheckSales Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustBe
          view(form, waypoints, period, list, index, country, canAddAnotherVatRate = true, Seq.empty, "CompanyName", true)(request, messages(application)).toString
      }
    }
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustBe
          view(boundForm, waypoints, period, list, index, country, canAddAnotherVatRate = true, List.empty, "Company Name", true)(request, messages(application)).toString
      }
    }
