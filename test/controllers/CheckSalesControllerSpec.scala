...
class CheckSalesControllerSpec extends SpecBase with MockitoSugar {

  def onwardRoute = Call("GET", "/foo")

  val formProvider = new CheckSalesFormProvider()
  val form = formProvider()

  lazy val checkSalesRoute = routes.CheckSalesController.onPageLoad(NormalMode, period).url
