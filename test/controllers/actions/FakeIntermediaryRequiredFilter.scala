...
class FakeIntermediaryRequiredFilter()
extends IntermediaryRequiredFilter(
  mock[FrontendAppConfig]
)(ExecutionContext.Implicits.global) {

  override def apply(): IntermediaryRequiredFilterImpl = new FakeIntermediaryRequiredFilterImpl()
