...
class CorrectionToCountrySpec extends AnyFreeSpec with Matchers with SpecBase {

  val country: Country = Country("DE", "Germany")
  val correctionToCountry: CorrectionToCountry = CorrectionToCountry(country, Some(BigDecimal("123.45")))

  "CorrectionToCountry" - {

    "serialize and deserialize correctly" in {
      val serializedJson = Json.toJson(correctionToCountry)
      val deserializedObject = serializedJson.as[CorrectionToCountry]

      deserializedObject mustEqual correctionToCountry
    }
